        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                <!-- 此处在进行路由跳转之前，还得向服务器发送请求，将加入产品的信息通过请求通知服务器，然后服务器进行相应的存储 -->
  ...
  methods: {
    ...
    async addShopCar(){
      ...
      try {
        ...
        // 进行路由跳转
        // 在路由跳转的同时将产品信息传递给下一级的路由组件
        // 一些简单的数据skuNum，通过query形式给路由组件传递过去
        // 一些复杂的数据skuInfo，通过会话存储sessionStorage给路由组件传递过去
